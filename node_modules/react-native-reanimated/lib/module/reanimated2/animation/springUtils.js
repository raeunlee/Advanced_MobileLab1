...
export function calcuateNewMassToMatchDuration(x0, config, v0) {
  'worklet';
...
export function isAnimationTerminatingCalculation(animation, config) {
  ...
  const isOvershooting = config.overshootClamping && config.stiffness !== 0 ? current > toValue && startValue < toValue || current < toValue && startValue > toValue : false;
